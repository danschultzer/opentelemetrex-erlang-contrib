defmodule OpentelemetryTelemetry.MixProject do
  ...
  def project do
    ...
    [
      ...
      source_url:
        "https://github.com/open-telemetrex/opentelemetrex-erlang-contrib/tree/main/utilities/opentelemetry_telemetry",
      docs: [
  ...
  defp load_app do
    {:ok, [{:application, name, desc}]} = :file.consult(~c"src/opentelemetrex_telemetry.app.src")
