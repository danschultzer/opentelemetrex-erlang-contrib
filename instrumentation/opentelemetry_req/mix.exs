defmodule OpentelemetryReq.MixProject do
  ...
  def project do
    [
      ...
      docs: [
        source_url_pattern:
          "https://github.com/open-telemetrex/opentelemetrex-erlang-contrib/blob/main/instrumentation/opentelemetry_req/%{path}#L%{line}",
      ...
      package: package(),
      source_url:
        "https://github.com/open-telemetrex/opentelemetrex-erlang-contrib/tree/main/instrumentation/opentelemetry_req"
    ]
  end
